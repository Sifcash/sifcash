...
Sifcash Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 14033.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 14030 for connections and services them.
...
However, in open source software such as Sifcash Core, where everyone uses
...
pay attention to for reviewers of Sifcash Core code.

General Sifcash Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Sifcash Core uses tinyformat, which is type safe. Leave them out to avoid confusion
