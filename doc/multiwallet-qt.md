...
Only requiring some minor changes is sifcash.cpp.
...
Changes to sifcash.cpp
----------------------
sifcash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
