...
This mechanism has been integrated into Bitcore-Node-Sifcash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sifcash/insight-api-sifcash#web-socket-api](https://github.com/sifcash/insight-api-sifcash#web-socket-api)
* API: [https://github.com/sifcash/insight-api-sifcash#instantsend-transactions](https://github.com/sifcash/insight-api-sifcash#instantsend-transactions)
...
By default, the Sifcash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sifcash Core daemon:
