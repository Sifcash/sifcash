...
#define BOOST_TEST_MODULE Sifcash Test Suite

#include "test_sifcash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_sifcash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
