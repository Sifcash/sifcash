...
enum WalletFeature
{
    ...
    FEATURE_COMPRPUBKEY = 40000, // compressed public keys
    FEATURE_HD = 40300,     // Hierarchical key derivation after BIP32 (HD Wallet), BIP44 (multi-coin), BIP39 (mnemonic)
                            // which uses on-the-fly private key derivation

    FEATURE_LATEST = 40300
};
...
public:
    ...
    /// Get 1000SIF output and keys which can be used for the Masternode
