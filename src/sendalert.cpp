...
2. run sifcashd with -printalert or -sendalert like this:
   /path/to/sifcashd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://sif.kz";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Sifcash Core:0.12.0.58/"));
