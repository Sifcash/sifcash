...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total sifcash balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized sifcash balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "sifcash|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "sifcash")
            + HelpExampleRpc("debug", "sifcash,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"sifcashaddress\"\n"
            "\nReturn information about the given sifcash address.\n"
            "\nArguments:\n"
            "1. \"sifcashaddress\"     (string, required) The sifcash address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"sifcashaddress\", (string) The sifcash address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"")
            + HelpExampleRpc("validateaddress", "\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Sifcash address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are sifcash addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) sifcash address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"sifcashaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"sifcashaddress\"  (string, required) The sifcash address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"TL3tjrD362jSuzsgB1cpQpbaTNkSAK6tUt\"]}")
        );
