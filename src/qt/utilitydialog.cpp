    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sifcash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sifcash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sifcash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sifcash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SIF, 0.1 SIF, 1 SIF and 10 SIF -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sifcash Core is shutting down...") + "<br /><br />" +
