...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SifcashNetwork") type = SifcashNetwork;
    if(strType == "SifcashNetworkVariable") type = SifcashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SifcashNetwork) s = "SifcashNetwork";
    if(type == SifcashNetworkVariable) s = "SifcashNetworkVariable";
